...
public class UserEntity implements UserDetails {
    ...
    public UserEntity(String email, String password, boolean accountNonExpired, boolean accountNonLocked, boolean accountEnabled, boolean credentialsNonExpired, Roles roles) {
        this.email = email;
