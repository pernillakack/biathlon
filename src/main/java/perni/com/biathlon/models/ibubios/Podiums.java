...
public class Podiums {
    ...
    public Podiums() {}
    public Podiums(int ALL_I_P, int WC_I_P, int WCH_I_P, int OWG_I_P, int ALL_I_P_G, int WC_I_P_G, int WCH_I_P_G, int OWG_I_P_G, int ALL_I_P_S, int WC_I_P_S, int WCH_I_P_S, perni.com.biathlon.models.ibubios.OWG_I_P_S OWG_I_P_S, int ALL_I_P_B, int WC_I_P_B, int WCH_I_P_B, perni.com.biathlon.models.ibubios.OWG_I_P_B OWG_I_P_B, int ALL_T_P, int WC_T_P, int WCH_T_P, int OWG_T_P, int ALL_T_P_G, int WC_T_P_G, perni.com.biathlon.models.ibubios.WCH_T_P_G WCH_T_P_G, int OWG_T_P_G, int ALL_T_P_S, int WC_T_P_S, int WCH_T_P_S, int OWG_T_P_S, int ALL_T_P_B, int WC_T_P_B, int WCH_T_P_B, perni.com.biathlon.models.ibubios.OWG_T_P_B OWG_T_P_B, int ALL_O_P, int WC_O_P, int WCH_O_P, int OWG_O_P, int ALL_O_P_G, int WC_O_P_G, int WCH_O_P_G, int OWG_O_P_G, int ALL_O_P_S, int WC_O_P_S, int WCH_O_P_S, int OWG_O_P_S, int ALL_O_P_B, int WC_O_P_B, int WCH_O_P_B, perni.com.biathlon.models.ibubios.OWG_O_P_B OWG_O_P_B, perni.com.biathlon.models.ibubios.IC_I_P_G IC_I_P_G, int ECH_I_P_G, int ICECH_I_P_G) {
    ...
    public perni.com.biathlon.models.ibubios.OWG_I_P_S getOWG_I_P_S() {
        return OWG_I_P_S;
    }

    public void setOWG_I_P_S(perni.com.biathlon.models.ibubios.OWG_I_P_S OWG_I_P_S) {
        this.OWG_I_P_S = OWG_I_P_S;
    }
    ...
    public perni.com.biathlon.models.ibubios.WCH_T_P_G getWCH_T_P_G() {
        return WCH_T_P_G;
    }

    public void setWCH_T_P_G(perni.com.biathlon.models.ibubios.WCH_T_P_G WCH_T_P_G) {
        this.WCH_T_P_G = WCH_T_P_G;
    }
